...
/** remplacer le chiffre 0 par les bonnes conditions **/
if($animal=="Chat" && $couleur=="Orange" && $vivant==true && $yeux=="Bleus"|| $animal=="Chien" && $vivant==true &&$couleur=="Marron" && $yeux=="Bleus"|| $animal=="Chien" && $vivant==false && $couleur=="Noir"&& $yeux=="Bleus" ){
  echo 'Oui';
}else {
  echo 'Non';
}
